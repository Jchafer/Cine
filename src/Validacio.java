...
public class Validacio {
	...
	static Calendar validaData() {
		...
		do {
			System.out.print("\tHora de la sessió? (hh:mm) ");
			strdata = s.nextLine();
	...
	static Calendar validaDataDefecte(Calendar antiga) {
		Calendar data;
		int year = 0, month = 0, day = 0, hour = 0, minute = 0;
		...
		do {
			System.out.print("\n\tData de la sessió? (dd/mm/aaaa) ["
					+ antiga.get(Calendar.DAY_OF_MONTH) + "/"
					+ antiga.get(Calendar.MONTH) + "/"
					+ antiga.get(Calendar.YEAR) + "]");
			strdata = s.nextLine();
